## Лабораторная работа 6. Нормализация реляционной базы данных. Поддержка логической целостности данных.
...
* SQL-команды для создания таблиц и заполнения их имеющимися данными поместить в файл db_init.sql. **Данный скрипт должен отрабатывать за не более чем 2 секунды!**
